...
func TestTxsJSON_Node(t *testing.T) {
	...
	tx2, err := transaction.NewTransactionFromHex("")
	assert.NoError(t, err)

	txs := transaction.Transactions{tx, tx2}

	bb, err := json.Marshal(txs.NodeJSON())
	assert.NoError(t, err)

	nTxs := make(transaction.Transactions, 0)
...
func TestTxsJSON_Node_MarshallJSON(t *testing.T) {
	tests := map[string]struct {
		...
		"transaction with 1 input 1 p2pksh output 1 data output should create valid json": {
			tx: func() transaction.Transactions {
				tx, err := transaction.NewTransactionFromHex("")
				assert.NoError(t, err)

				tx2, err := transaction.NewTransactionFromHex("")
				assert.NoError(t, err)
				return transaction.Transactions{tx, tx2}
			}(),
			expJSON: `[
	{
		"version": 1,
...
func TestTxsJSON_Node_UnmarshalJSON(t *testing.T) {
	...
	tests := map[string]struct {
		json   string
		expTxs transaction.Transactions
	}{
	...
	},
	{
		...
		"lockTime": 119
			...
			expTxs: func() transaction.Transactions {
				tx, err := transaction.NewTransactionFromHex("")
				assert.NoError(t, err)
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			txs := make(transaction.Transactions, 0)
