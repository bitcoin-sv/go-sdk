...
// SignWithCustomK generates an ECDSA signature over a message using the private key and custom K value.
func SignWithCustomK(msg []byte, privateKey *e.PrivateKey, forceLowS bool, customK *big.Int) (
