...
func TestNewAddressFromString(t *testing.T) {
	...
	t.Run("mainnet", func(t *testing.T) {
		...
		assert.Equal(t, "8fe80c75c9560e8b56ed64ea3c26e18d2c52211b", hex.EncodeToString(addr.PublicKeyHash), addressMain)
	...
	t.Run("testnet", func(t *testing.T) {
		...
		assert.Equal(t, "8fe80c75c9560e8b56ed64ea3c26e18d2c52211b", hex.EncodeToString(addr.PublicKeyHash), addressTestnet)
...
func TestNewAddressFromPublicKeyString(t *testing.T) {
	...
	t.Run("mainnet", func(t *testing.T) {
		...
		assert.Equal(t, testPublicKeyHash, hex.EncodeToString(addr.PublicKeyHash))
